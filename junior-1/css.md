...
* Flex
  ...
  * Что такое flex-container и flex-items?
    * Flex-container - родительский элемент, которому задано свойство `display: flex` принято называть контейнером, а дочерние элементы, расположенные в этом контейнере называются flex-items.
...
* Как отцентрировать элемент по горизонтали (назвать хотя бы три способа)?
* Как отцентрировать элемент по вертикали (назвать хотя бы три способа)?
