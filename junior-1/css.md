...
* Шрифты
  * Как и в каких единицах можно задавать размер шрифта?
    *  Ems (em): — это масштабируемая единица, которая используется в веб-документах. em равна ближайшему font-size родительского элемента, например, если font-size в документе 12px, 1em равен 12px. em масштабируема по своей природе, так 2em будет равен 24px, 0.5em будет равна 6px и т.д.
